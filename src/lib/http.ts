...
const ERROR_STATUS = {
  ...
  RECURRENCE_OCCURRENCE_CONFLICT: 409,
...
const DEFAULT_MESSAGES: Record<ErrorCode, string> = {
  ...
  CUSTOM_RATE_NOT_FOUND: "Custom exchange rate not found.",
  ...
  RECURRENCE_OCCURRENCE_CONFLICT: "Conflicting changes for the same recurring occurrence.",
